...
RSpec.describe ObservationValidator do
  let(:patient) do
  ...
  it "is valid for a well-formed observation referencing an existing patient" do
  ...
  it "requires code" do
    result = described_class.call(payload("Patient/#{patient.id}").except("code"))
